...
import { createExpenditure } from "../../features/expenditures/expenditureSlice";
...
function ExpenditureForm() {
  ...
  const onSubmit = (e) => {
    ...
    //dispatch the function call createExpenditure
    //pass the object with the text
    dispatch(createExpenditure(expenditureData));
    //clear the form
    //setText('')
  };
    ...
    <section className="form">
      <form onSubmit={onSubmit}>
        <div className="form-group">
          <label htmlFor="description">Expenditure Name</label>
          <input
            type="text"
            name="description"
            id="description"
